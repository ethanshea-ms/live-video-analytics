...
3. Install the [requirements for running LVA Jupyter notebook samples](../../utilities/video-analysis/notebooks/common/requirements.md) on your development PC.
...
2. **Optional:** For this sample, you are going to utilize Rocket’s ability to count and alert when objects cross lines of interest in a frame. Download the [sample video file](https://aka.ms/lva-rocket-videosample) at your convenience to [learn more about](./notebooks/line_configuration.md) configuring your own lines of interest.
