...
| 3         | Physical PC<br>-OS: Windows 10 with<br> [WSL Ubuntu 18.04](https://docs.microsoft.com/en-us/windows/wsl/about)<br>-Python 3.6.9, Pip 3 | Azure VM<br>-OS: Ubuntu 18.04 |
